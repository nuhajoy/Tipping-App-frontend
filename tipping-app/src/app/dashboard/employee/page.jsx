                    ...
                    {[
                        ...
                        >
                            <CardHeader className="flex items-center justify-between text-sm text-[#666]">
                                ...
                                <span className="inline-flex items-center justify-center w-8 h-8 rounded-full shadow-sm bg-[#00C853]/10 text-[#00C853] text-xl font-bold">{stat.icon}
                                </span>
                            </CardHeader>
                    ...
                    {[
                        ...
                        <Card key={i} className="bg-white shadow-sm rounded-lg p-4">
                            <CardHeader className="flex items-center justify-between text-sm text-[#666">
                                ...
                                <span className="inline-flex items-center justify-center w-8 h-8 rounded-full shadow-sm bg-[#FF6B00]/10 text-[#FF6B00] text-xl font-bold">{info.icon}
                                </span>
                            </CardHeader>
                ...
                <section>
                    ...
                    <div className="space-y-3">
                        {mockData.tips.slice(0, visibleTips).map((tip, i) => (
                            ...
                            >
                                <div>
                                    <p className="font-medium text-[#1A1A1A]">{tip.amount} ETB</p>
                                    <p className="text-xs text-[#666]">
                                        {tip.date} • {tip.time}
                                    </p>
                                </div>
                ...
                <section>
                    ...
                    <div className="space-y-2">
                        {mockData.weeklyPerformance.map((day, i) => (
                            <div key={i} className="flex justify-between text-sm text-[#666]">
                                <span>{day.day}</span>
